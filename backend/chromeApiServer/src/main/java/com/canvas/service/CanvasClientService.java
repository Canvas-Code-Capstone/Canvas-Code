...
public class CanvasClientService {
    ...
    private JsonNode fetchFolders(String folderId) throws IOException {
        Request request = new Request.Builder()
    ...
    private JsonNode fetchFilesUnderFolder(String folderId) throws IOException {
        Request request = new Request.Builder()
    ...
    public void fetchSubmissionFromMyFilesAndSave() throws IOException {
        ...
        String submissionFileId = this.getFileId(canvasCodeFolderId, "sample.cpp");
        byte[] fileBytes = this.fetchFile(submissionFileId);

        FileService fs = new FileService();
        fs.writeFile("/tmp","sample.cpp",fileBytes);
    }
